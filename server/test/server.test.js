...
describe('DELETE /todos/:id',() => {
  it('should remove a todo expecting 200', (done) => {
  ...
  it('should remove a todo expecting 404', (done) => {
...
describe('GET /users/me', () => {
  ...
  it('should reutn 401 if not authenticated', (done) => {
    request(app)
      .get('/users/me')
      .expect(401)
      .expect((res) => {
...
describe('DELETE /users/me/token', () => {
  it('should remove auth token on logout', (done)=>{
    ...
    // Find user, verify that token has length of zero 
